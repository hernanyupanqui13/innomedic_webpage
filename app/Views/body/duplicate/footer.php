	...
	<div class="footer-bottom">
		<div class="container">
			<div class="row text-center text-md-left">
				...
				<div class="col-sm-auto ml-auto"><span class="d-none d-sm-inline">Ponte en contacto&nbsp;&nbsp;&nbsp;</span><i class="icon-telephone"></i>&nbsp;&nbsp;<b><a href="tel:<?php echo $telephonex; ?>"><?php echo $telephonex; ?></a>&nbsp;<a href="tel:<?php echo $phone_onex; ?>"><?php echo $phone_onex; ?></a></b>&nbsp;&nbsp;&nbsp;<a class="font-weight-bold" target="_blank">By design</a></div>
			</div>
		</div>
	</div>
</div>
				...
				<div class="modal-form">
					...
					<form class="mt-15" id="bookingForm" method="post" novalidate="">
						...
						<div class="row row-xs-space mt-1">
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nruc" id="nrucx" placeholder="Ingrese Ruc y presione la tecla 'enter' " maxlength="11" pattern="([0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]|[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9])">
								</div>
							</div>
						...
						<div class="text-center mt-2">
							<button type="submit" class="btn btn-sm btn-hover-fill"><i class="fas fa-paper-plane"></i>&nbsp;Enviar cotización</button>
						</div>
					</form>
				</div>
			</div>
