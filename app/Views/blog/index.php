						...
						<div class="blog-posts">
							...
							<div class="blog-post">
								...
								<div class="post-teaser">
									<p>Becoming a dentist can result in an abundance of professional possibilities. Besides private practice options, dental school graduates can teach future dentists, travel with international health and relief organizations, work in hospital emergency rooms, or conduct advanced laboratory research.</p>
									<div class="quote">
										...
										<p>Admission to dental school is highly competitive, but the application process is straightforward. In fact, many U.S. dental schools utilize the American Association of Dental Schools Application Service enabling you to submit one online application and send it to a variety of schools.</p>
									</div>
								</div>
								<div class="mt-3 mt-lg-4"><a href="blog-post-page.html" class="btn btn-sm btn-hover-fill"><i class="icon-right-arrow"></i><span>Read more</span><i class="icon-right-arrow"></i></a></div>
							</div>
